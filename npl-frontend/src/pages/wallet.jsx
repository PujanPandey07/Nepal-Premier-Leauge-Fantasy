        ...
        <div className="min-h-screen bg-gray-50 overflow-x-hidden">
            ...
            <div className="max-w-2xl mx-auto px-4 py-6 sm:px-6 sm:py-8">
                ...
                <div className="bg-slate-900 text-white rounded-2xl p-5 sm:p-6 mb-5 sm:mb-6 shadow-md border border-slate-800">
                    <p className="text-xs sm:text-sm text-gray-400 mb-1 font-medium uppercase tracking-wider">
                        Current Balance
                    </p>
                ...
                <div className="bg-white rounded-2xl border border-gray-200 p-4 sm:p-5 mb-5 sm:mb-6 shadow-sm">
                    ...
                    <h2 className="font-bold text-sm sm:text-base text-gray-800 mb-3">
                        Top Up Wallet
                    </h2>

                    {error && (
                        <p className="text-red-500 text-xs sm:text-sm mb-3 font-medium bg-red-50 p-2.5 rounded-lg border border-red-100">
                            {error}
                        </p>
                    )}
                    ...
                    <p className="text-[11px] sm:text-xs text-gray-400 mt-2.5">
                        This is a simulated Khalti payment for demonstration purposes.
                    </p>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                    ...
                    {transactions.length === 0 ? (
                        <p className="text-gray-500 text-xs sm:text-sm p-4 sm:p-6 text-center">
                            No transactions yet.
                        </p>
                    ) : (
                            ...
                            {transactions.map(tx => (
                                ...
                                >
                                    ...
                                    <div className="text-right shrink-0">
                                        ...
                                        <p
                                            className={`text-[10px] sm:text-xs font-semibold capitalize mt-0.5 ${
                                                tx.status === 'completed'
                                                    ? 'text-emerald-500'
                                                    : tx.status === 'failed'
                                                    ? 'text-red-400'
